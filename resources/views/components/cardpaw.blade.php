<div class="container" style="padding-top: 1.5rem;">
    <div class="row">
        @for ($i = 1; $i <= 4; $i++)
            <div class="col-md-3">
                <div class="card center" style="padding-top: 1.5rem;">
                    <div style="background-color: white">
                        <div class="card-body">
                            ...
                            <center>
                                <div class="card-text" id="titlecard1">
                                    <h1>Lorem ipsum<br>dolor sit amet</h1>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, error delectus voluptates ducimus.</p>
                                </div>
                            </center>
                        </div>
                    </div>
